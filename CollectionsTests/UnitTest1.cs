...
namespace CollectionsTests
{
    public class CollectionListTest
    {
        ...
        {
            //Act
            var interSectionSet = leftList.Intersect(rightList); // Intersect right ve left listte bulunan ortak elemanlarý yazdýrýr
        ...
        {
            //Act
            var unionSet = leftList.Union(rightList); // union right ve left listi birleþtirir tekrar eden elemanlarý saymaz
